import { protegerPagina, cerrarSesion } from './auth.js?v=10';
import { supabase } from './supabaseClient.js?v=10';
import { cargarConfiguracionNegocio } from './theme.js?v=10';
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key:'servicios', label:'Tienda', href:null, enabled:false,
